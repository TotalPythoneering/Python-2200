...
# DATE: 2023-08-10 13:15:12
# FILE: AbsZooOrder4.py
# AUTHOR: Randall Nagy
# The Random Zookeep
...
class GameParams:
   ...
   @classmethod
   @abc.abstractmethod
   def from_recipe(a_recipe):
      return a_recipe.mk_game()
...
if __name__ == '__main__':
   print(ClassicGameParams.from_recipe().title)
   print(TestableGameParams.from_recipe().title)
